...
You need to install at least a Java Runtime Environment (JRE) 5 before
running this application. You can download a JRE at
...
cvs.librazur.berlios.de:/cvsroot/librazur:librazur/blc using the
login anonymous and no password. You can also view the CVS repository
at http://cvs.berlios.de/cgi-bin/viewcvs.cgi/librazur/librazur/blc.

Thanks for your interest in Librazur BLC.
